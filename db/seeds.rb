...
tool_2 = Tool.create(name: 'Car Lift', price: '50', details: 'car lift on site cars/suv/small trucks up to 15,000lbs', img_url:"https://www.forwardlift.com/wp-content/uploads/2019/08/I10_Honda_BL.jpg", available: true)
...
tool_4 = Tool.create(name: 'Graco SaniSpray HP 130 2-Gun Cart Airless Sprayer', price: '50', details: 'Airless sprayer', img_url:"https://www.portlandcompressor.com/images/thumbs/000/0003548_graco-ultra-max-ii-495-pc-pro-electric-airless-paint-sprayer-stand_550.jpeg", available: true)
tool_5 = Tool.create(name: 'Cement Mixer', price: '20', details: 'cement mixer heavy duty', img_url:"https://www.constructioncomplete.com/media/catalog/product/cache/1/thumbnail/126x126/9df78eab33525d08d6e5fb8d27136e95/c/r/crnconcretesteel_1_28.jpg" , available: true)
